...
digraph process {
    ...
    "Run full test suite, report status to user" [shape=box style=filled fillcolor=lightgreen];
    ...
    "Dispatch final code reviewer subagent for entire implementation" -> "Run full test suite, report status to user";
}
```
