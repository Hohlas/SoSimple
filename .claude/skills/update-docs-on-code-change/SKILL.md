...
Файл CONTEXT_HANDOFF.md должен содержать лаконичный контекст текущего состояния работы над проектом, прочитав который ИИ агент сможет продолжить работу в новой сессии.
