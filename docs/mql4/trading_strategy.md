...
## 0. Инструкция агенту по управлению процессом тестирования

> **Важно!**
> 1. После внесения правок обязательно сменить значение VERSION в MT/MQL4/Experts/$o$imple.mq4:2
> По этому значению можно судить об обновлении скомпилированной версии в логах по строке вида: "OnInit() SoSimple.V260.xxx ..."
> 2. Изменить/проверить входные параметры эксперта перед тестом: MT/tester/$o$imple.ini
> 3. Удалить старые логи тестирования MT/tester/logs/*.log
> 4. Сообщить пользователю: "Изменения готовы. Запустите тестер вручную (F5 в окне Strategy Tester) и сообщите результаты.".
> 5. После получения результатов от пользователя:
>  - Открыть новые логи MT/tester/logs/*.log
>  - Сравнить VERSION из лога с ожидаемым
>  - Извлечь нужные метрики 
