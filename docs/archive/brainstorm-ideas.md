...
Без ранжирования. Один кластер = один механизм edge. Кластеры 1–19 (в пределах потолка 20).
...
## Multi-scale amplitude decomposition [кластер 1]
...
## MFE conditional quantile exit [кластер 2]
...
## Queue Imbalance Microstructure [кластер 3]
...
## Nero tick-flow imbalance [кластер 3]
...
## Adverse selection cost model as signal [кластер 4]
...
## BOCPD Regime Switching [кластер 5]
...
## Adversarial regime gate [кластер 5]
...
## Synthetic Control Anomaly [кластер 6]
...
## Cross-sectional FX rank selection [кластер 6]
...
## Cross-asset lead-lag signals [кластер 7]
...
## Ultra-low frequency regime bets [кластер 8]
...
## Topological Persistence Features [кластер 9]
...
## Fractal structural similarity [кластер 9]
...
## Bootstrap agreement meta-signal [кластер 15]
...
## Carry-momentum interaction on EM FX [кластер 16]
