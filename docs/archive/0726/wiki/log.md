...
## [2026-07-26] ingest | Fixed11 candidate audit
- Добавлен охват `docs/reports/2026-07-25-fractal0-fixed11-candidate-audit.md`.
- Обновлён `wiki/research/fractal-stop-research.md`: locked_test больше не описывается как reject; зафиксировано, что 11 frozen rules прошли individual locked-test gates, но независимый candidate audit заблокировал повышение статуса.
- Обновлён `wiki/index.md`: охват fractal-stop research расширен до 60 report updates.
- Зафиксировано: `candidate_audit_blocked`; запрещены correlation pruning, MT4/tester parity и model card до устранения freeze/disclosure blockers без изменения frozen rules.
