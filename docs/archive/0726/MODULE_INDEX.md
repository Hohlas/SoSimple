...
| [audit_fractal0_fixed11_candidate.py](ML/baseline/audit_fractal0_fixed11_candidate.py) | Read-only audit fixed11 locked-test bundle перед повышением статуса выше `candidate_check_required` | locked-test JSON/CSV + freeze/policy artifacts → `fractal0_fixed11_candidate_audit.json`, `fractal0_fixed11_candidate_audit_findings.csv` | [docs](docs/ML/audit_fractal0_fixed11_candidate.py.md) | ✅ |
