...
[`docs/audit/ml_trading_methodology.md`](audit/ml_trading_methodology.md) — управляющий документ качества ML-разработки и аудита торговых моделей. Он задаёт обязательные проверки, критерии перехода между этапами и правила интерпретации результатов.
