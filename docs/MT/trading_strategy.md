...
Практический нюанс: `BackTest` соответствует физической строке файла в текущей логике чтения. При одной строке заголовка и одной рабочей строке первая рабочая строка получает `BackTest=3`.
