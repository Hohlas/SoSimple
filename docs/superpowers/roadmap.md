...
Status: **SHORTLISTED (3)** — first implementation check completed, `early_timeout_hold_bars=12` rejected by canonical validation gate

| Rank | Plan | pf_delta | N_drop | Status |
|------|------|:--------:|:------:|--------|
| 1 | [NY session filter](plans/2026-04-13-ny-session-filter.md) | +12.097 | 29% | Next validation-first candidate |
...
Recommended execution order now: NY session filter → pred_adv cap. `Early timeout` stays as completed negative verdict and should not be productized further without new evidence.
