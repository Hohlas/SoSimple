...
`2022.10.28` - `2025.12.31`, но полный диапазон требует отдельного прогона
как минимум до конца марта 2026, лучше до `2026.04.22` плюс запас на закрытие
последней позиции.
...
Следующий шаг: прогнать полный период до конца файла сигналов и повторить
reconciliation без ограничения `--end-time 2025.12.31 23:59`.
