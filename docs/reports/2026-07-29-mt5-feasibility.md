...
> **Дата**: 2026-07-29
> **Статус**: Superseded by `docs/reports/2026-07-29-mt5-execution-loop-migration.md`
...
- Existing `$o$imple.mq5` was compiled on 2026-07-30 with MetaEditor 5; compile log `/tmp/sosimple_mt5_compile.log` reports `Result: 0 errors, 0 warnings`, and `MT/MQL5/Experts/$o$imple.ex5` was refreshed at 2026-07-30 06:12:07 UTC.
...
- `lib_ML_Signal.mqh` now has the diagnostic MT5 execution-loop event CSV writer `MT5_ML_LogEvent(...)`; however, intrabar fill-and-close logging and full MT5 deal/history reconciliation remain unproven.
