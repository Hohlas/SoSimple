...
| [`superpowers/roadmap.md`](superpowers/roadmap.md) | Короткая очередь будущих research-направлений, которые ещё не превращены в отчёты | Меняется порядок крупных направлений работ или появляются новые ветки после завершённых аудитов | Короткий ordered backlog + ссылки на планы/отчёты |
