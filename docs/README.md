...
| `ML/`, `MT/`, `processing/`, `statistics/`, `tests/` | Module-level docs | Меняется CLI, назначение, вход/выход или ограничения модуля | Назначение, входы, выходы, запуск, ограничения |
