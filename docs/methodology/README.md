...
Методика применяется к любому новому ML-кандидату: классификации направления, регрессии MFE/MAE, take/skip, triple barrier, фильтру сигналов, execution-policy или модели выбора стороны сделки. Для торговых постановок с явным правилом входа/выхода до обучения модели выполняется oracle-preflight (проверка потолка): диагностическая проверка теоретического максимума механики при идеальном знании будущих labels.
