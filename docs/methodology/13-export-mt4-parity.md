...
11. Для MT5-контуров использовать отдельную методику
    [`13b-mt5-execution-parity.md`](13b-mt5-execution-parity.md). Общие
    требования этого файла к frozen export, reconciliation и запрету
    подгонки по tester-результату остаются обязательными.
