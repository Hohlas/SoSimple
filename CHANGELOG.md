...
### Исправлено
- Решена проблема невоспроизводимости из аудита: код признан полностью детерминированным. С `seed=42` и зафиксированными параметрами прогон 4 нейросетей повторяет результаты от 10 марта с точностью до 6 знаков.
