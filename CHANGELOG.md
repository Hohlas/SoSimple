...
- Годы `2023-2025` используются для диагностического управленческого решения; `2026` раскрывается отдельно как год с малым числом наблюдений

### Результаты
- **Вердикт: DIAGNOSTIC_ONLY**
- Общий итог: **неопределённый** — не удалось ни доказать распад сигнала во времени, ни подтвердить его устойчивость
- Для обеих целей `rolling` не дал ни одного года, где его доверительный интервал был бы строго лучше `fixed` на решающих годах `2023-2025`
...
### Вывод
Stage 5.0f не даёт оснований ни закрыть тему как доказанно неустойчивую, ни реабилитировать её как устойчивую. Результат следует использовать только как диагностический; следующая подтверждающая проверка потребует нового периода `2026+` или явного раскрытия, что независимая проверка уже сожжена.
