...
| [benchmark_fractal0_entry_exit_grid.py](ML/baseline/benchmark_fractal0_entry_exit_grid.py) | Fractal0 entry/exit grid со stop-policy grid, M5 fill timestamp / same-H1 ordering, ML-exit и permutation correction | labeled CSV + H1/M5 OHLC + frozen movement scores → entry/exit/stop-grid JSON/CSV | [docs](docs/ML/benchmark_fractal0_entry_exit_grid.py.md) | ✅ |
...
| [run_fractal0_fixed11_rich_entry_locked_test.py](ML/baseline/run_fractal0_fixed11_rich_entry_locked_test.py) | Wrapper 11 fixed normalized rich-entry rules для locked-test/rerun с M5 fill timestamp и diagnostic contract fields | fixed rules + stop-grid artifact + locked_test CSV + H1/M5 OHLC → fixed11 JSON/CSV | [docs](docs/ML/run_fractal0_fixed11_rich_entry_locked_test.py.md) | ✅ |
...
| [mt5_signal_schema.py](ML/baseline/mt5_signal_schema.py) | Executable schema source для MT5 signal/event CSV и timing validators | `entry_signals.csv`, `events.csv` → schema validation | [docs](docs/ML/mt5_execution_loop.md) | ✅ |
| [prepare_mt5_entry_source.py](ML/baseline/prepare_mt5_entry_source.py) | H1 bridge из entry-quality rows в MT5 diagnostic timing contract | entry-quality CSV → prepared signal source + metadata | [docs](docs/ML/mt5_execution_loop.md) | ✅ |
| [export_mt5_entry_signals.py](ML/baseline/export_mt5_entry_signals.py) | Экспорт MT5 entry signals с timing metadata и run_config hash | prepared signal source → `entry_signals.csv/json` | [docs](docs/ML/mt5_execution_loop.md) | ✅ |
| [run_mt5_batch.py](ML/baseline/run_mt5_batch.py) | Batch-runner для 32 MT5 diagnostic candidates | candidate config → batch `entry_signals`, `events`, `metrics`, `batch_summary` | [docs](docs/ML/mt5_execution_loop.md) | ✅ |
| [mt5_execution_diagnostics.py](ML/baseline/mt5_execution_diagnostics.py) | Read-only diagnostics для MT5 event logs, errors и timing contract | batch/reference events → diagnostics JSON/CSV | [docs](docs/ML/mt5_execution_loop.md) | ✅ |
