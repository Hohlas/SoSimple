...
| [benchmark_stage5_transformer_breach.py](ML/baseline/benchmark_stage5_transformer_breach.py) | Stage 5.0 Transformer Breach runner + Stage 5.0a feature preflight + Stage 5.0d diagnostic screening (XGBoost + Logistic, no Transformer): профили признаков, нормализация, distribution audit, абляция групп | `DATA/Nero_XAUUSD_*_labeled.csv` → `ML/reports/stage5_transformer_breach.json`, `ML/reports/stage5_0a_feature_preflight.json`, `ML/reports/stage5_0a_feature_stats_normalized.csv`, `ML/reports/stage5_0a_profile_summary.csv`, `ML/reports/stage5_0d_diagnostic_screening.json` | [docs](docs/ML/benchmark_stage5_transformer_breach.py.md) | 🏁 |
