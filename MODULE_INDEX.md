...
| [benchmark_stage5_transformer_breach.py](ML/baseline/benchmark_stage5_transformer_breach.py) | Stage 5.0 runner и диагностические подпотоки 5.0a-5.3: Transformer, feature audit, profile screening, stationarity, structural/UpDn ablation и time-to-breach diagnostics | `DATA/Nero_XAUUSD_*_labeled.csv` → `ML/reports/stage5_transformer_breach.json`, `ML/reports/stage5_0a_feature_preflight.json`, `ML/reports/stage5_0f_signal_stationarity.json`, `ML/reports/stage5_1_structural_field_ablation.json`, `ML/reports/stage5_1b_updn_field_ablation.json`, `ML/reports/stage5_2_time_to_breach_regression.json`, `ML/reports/stage5_3_time_to_breach_target_reformulation.json` | [docs](docs/ML/benchmark_stage5_transformer_breach.py.md) | 🏁 |
| [benchmark_stage6_2_price_action.py](ML/baseline/benchmark_stage6_2_price_action.py) | Stage 6.2 DIAGNOSTIC_ONLY: H12 OHLC price-action family, same-run baseline delta, preflight, runner, gate | `DATA/Nero_XAUUSD_*_labeled.csv` + OHLC → `ML/reports/stage6_2_h12_price_action_feature_family.json` | [docs](docs/ML/benchmark_stage6_2_price_action.py.md) | ✅ |
| [analyze_stage6_2_range_w1_postmortem.py](ML/baseline/analyze_stage6_2_range_w1_postmortem.py) | Stage 6.2 DIAGNOSTIC_ONLY post-mortem: why `range_w1_atr` dominates and why permutation stability remains weak | Stage 6.2 JSON + labeled CSV + OHLC → `ML/reports/stage6_2_range_w1_postmortem.json`, report | [docs](docs/ML/analyze_stage6_2_range_w1_postmortem.py.md) | ✅ |
| [benchmark_entry_based_updn_fractal_selection_ablation.py](ML/baseline/benchmark_entry_based_updn_fractal_selection_ablation.py) | DIAGNOSTIC_ONLY runner: frozen representation ablation (`all100`, `nearest_k`, `corridor_Xatr`, `zones`) на фиксированном `entry-based next open` target; единые `Up/Dn` горизонты 3/6/12, all-horizon summary, smoke disclosure | foundation splits + fractal columns + ATR → `ML/reports/entry_based_updn_fractal_selection_ablation*.{json,csv}` | [docs](docs/ML/benchmark_entry_based_updn_fractal_selection_ablation.py.md) | ✅ |
| [benchmark_entry_based_next_open_closeout.py](ML/baseline/benchmark_entry_based_next_open_closeout.py) | DIAGNOSTIC_ONLY closeout runner: shortlist `entry-based next open`, large validation, `H3/H6/H12/H24`, entry smoke-check, full serialized `Up/Dn`, scale audit и verdict `STOP/PIVOT/CONTINUE` | foundation splits + fractal columns + ATR → `ML/reports/entry_based_next_open_closeout*.{json,csv}` | [docs](docs/ML/benchmark_entry_based_next_open_closeout.py.md) | ✅ |
| [benchmark_entry_based_powerful_tabular.py](ML/baseline/benchmark_entry_based_powerful_tabular.py) | DIAGNOSTIC_ONLY runner мощных табличных моделей для `entry-based next open`: XGBoost/LightGBM/CatBoost/ExtraTrees/HGB, control `all100`, candidate-only summary, split-overlap gate, audit decisions и verdict `REJECT/PIVOT_AMPLITUDE/DIRECTION_REPLICATION_REQUIRED` | foundation splits + closeout feature builder → `ML/reports/entry_based_powerful_tabular*.{json,csv}` | [docs](docs/ML/benchmark_entry_based_powerful_tabular.py.md) | ✅ |
...
| [test_entry_based_updn_fractal_selection_ablation.py](tests/test_entry_based_updn_fractal_selection_ablation.py) | `ML/baseline/benchmark_entry_based_updn_fractal_selection_ablation.py` — frozen registry, feature horizon contract, progress/resume, thread contract, all-horizon summary и artifact logic | [docs](docs/tests/tests.md) | ✅ |
| [test_entry_based_next_open_closeout.py](tests/test_entry_based_next_open_closeout.py) | `ML/baseline/benchmark_entry_based_next_open_closeout.py` — shortlist scope, entry smoke-check, `H24`, full serialized `Up/Dn`, scale audit, metrics и verdict rules | [docs](docs/tests/tests.md) | ✅ |
| [test_entry_based_powerful_tabular.py](tests/test_entry_based_powerful_tabular.py) | `ML/baseline/benchmark_entry_based_powerful_tabular.py` — powerful tabular scope, CatBoost/LightGBM/XGBoost factory, `all100` control split, split-overlap guard, audit decisions, normalization contract, yearly metrics и verdict rules | [docs](docs/tests/tests.md) | ✅ |
...
| [2026-06-18-stage5_0a-corridor-full-preflight.md](docs/superpowers/plans/2026-06-18-stage5_0a-corridor-full-preflight.md) | План Stage 5.0a Corridor Full Preflight: честный raw coverage до cap, full corridor-профили и разделение ATR как масштаба и как входа модели |
