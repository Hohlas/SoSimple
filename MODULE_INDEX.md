...
| [benchmark_stage5_transformer_breach.py](ML/baseline/benchmark_stage5_transformer_breach.py) | Stage 5.0 runner и диагностические подпотоки 5.0a-5.1: Transformer, профили признаков, нормализация, audit распределений, скрининг профилей, проверка устойчивости сигнала и структурная field ablation | `DATA/Nero_XAUUSD_*_labeled.csv` → `ML/reports/stage5_transformer_breach.json`, `ML/reports/stage5_0a_feature_preflight.json`, `ML/reports/stage5_0a_feature_stats_normalized.csv`, `ML/reports/stage5_0a_profile_summary.csv`, `ML/reports/stage5_0d_diagnostic_screening.json`, `ML/reports/stage5_0f_signal_stationarity.json`, `ML/reports/stage5_1_structural_field_ablation.json` | [docs](docs/ML/benchmark_stage5_transformer_breach.py.md) | 🏁 |
