...
| [signal_tracer.py](statistics/signal_tracer.py) | Trade-level reconciliation: ML vs MT4 | `ml_signals.csv` + `Nero_*_labeled.csv` + `Nero_*_updn_params.npy` + log → dossiers, CSV | [docs](docs/data_analysis/signal_tracer.py.md) | ✅ |
