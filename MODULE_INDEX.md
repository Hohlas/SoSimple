...
| [benchmark_fractal0_entry_exit_grid.py](ML/baseline/benchmark_fractal0_entry_exit_grid.py) | Fractal0 entry/exit grid с OHLC-симуляцией, ML-exit и permutation correction | labeled CSV + OHLC + frozen movement scores → entry/exit grid JSON/CSV | [docs](docs/ML/benchmark_fractal0_entry_exit_grid.py.md) | ✅ |
