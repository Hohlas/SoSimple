...
| Что сделать | Команда |
|---|---|
| Обновить docs после правки кода | `обнови документацию` |
| Добавить docs для существующего файла | `doc this путь/к/файлу.py` |
| Создать новый модуль с docs | `create module имя` |
| Обновить MODULE_INDEX.md | `rebuild module index` |
