...
> 
> Ты работаешь с проектом SoSimple. Прочитай AGENTS.md и [.ai/RULES_INDEX.md](file:///home/hohla/git/SoSimple/.ai/RULES_INDEX.md).
>
> **Контекст**: Завершены этапы предобработки и EDA. Статистические результаты в [statistics/reports/EDA_report.md](file:///home/hohla/git/SoSimple/statistics/reports/EDA_report.md), [statistics/plots/feature_stats_by_class.csv](file:///home/hohla/git/SoSimple/statistics/plots/feature_stats_by_class.csv), [statistics/plots/statistical_tests.csv](file:///home/hohla/git/SoSimple/statistics/plots/statistical_tests.csv). Рекомендации по моделированию — в [statistics/sequence_analysis_report.md](file:///home/hohla/git/SoSimple/statistics/sequence_analysis_report.md). Описание формата данных и целевых переменных — [docs/dataset_description.md](file:///home/hohla/git/SoSimple/docs/dataset_description.md). Поток данных — [docs/DATA_FLOW.md](file:///home/hohla/git/SoSimple/docs/DATA_FLOW.md).
>
...
>
> **Требования к данным**:
> 1. Загружать данные из [DATA/Nero_train_labeled.csv](file:///home/hohla/git/SoSimple/DATA/Nero_train_labeled.csv) (train) и [DATA/Nero_validation_labeled.csv](file:///home/hohla/git/SoSimple/DATA/Nero_validation_labeled.csv) (validation). Разделитель `;`. НЕ перемешивать данные (time-series!).
...
> 3. Для feature-based моделей использовать уже готовые engineered features из EDA (файлы [statistics/nero_features_engineered.csv](file:///home/hohla/git/SoSimple/statistics/nero_features_engineered.csv) и [statistics/feature_catalog.json](file:///home/hohla/git/SoSimple/statistics/feature_catalog.json)) — но помни, что этот файл содержит только train split. Для validation применить ту же логику feature engineering.
...
> Ты работаешь с проектом SoSimple. Прочитай AGENTS.md и [.ai/RULES_INDEX.md](file:///home/hohla/git/SoSimple/.ai/RULES_INDEX.md).
>
> **Контекст**: Завершены этапы 1-2 (предобработка, EDA). Baseline-модели обучены (результаты в `ML/reports/baseline_report.md`). Описание данных: [docs/dataset_description.md](file:///home/hohla/git/SoSimple/docs/dataset_description.md). Статистика: [statistics/reports/EDA_report.md](file:///home/hohla/git/SoSimple/statistics/reports/EDA_report.md).
>
...
>
> **Требования к данным**:
> 1. Загружать [DATA/Nero_train_labeled.csv](file:///home/hohla/git/SoSimple/DATA/Nero_train_labeled.csv) (train), [DATA/Nero_validation_labeled.csv](file:///home/hohla/git/SoSimple/DATA/Nero_validation_labeled.csv) (val). Разделитель `;`.
...
>    - Обновить [AGENTS.md](file:///home/hohla/git/SoSimple/AGENTS.md): секцию "Статус разработки" — отметить "Выбор архитектуры ✅"
>    - Обновить [docs/PRD.md](file:///home/hohla/git/SoSimple/docs/PRD.md): roadmap — отметить "Выбор архитектуры" как выполненный
