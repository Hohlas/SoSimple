# =============================================================================
# Файл: entry_path_v1_quantile_transformer.py
# Назначение: Entry Path v1 Transformer с дополнительными quantile-головами.
# Язык: Python 3.10+
# =============================================================================
...
class EntryPathV1QuantileTransformer(nn.Module):
    def __init__(
        self,
        ...
        self.ret_q10_head = nn.Sequential(
            nn.Dropout(dropout),
            nn.Linear(d_model, 32),
            nn.ReLU(),
            nn.Dropout(dropout),
        ...
        self.ret_q90_head = nn.Sequential(
            nn.Dropout(dropout),
            nn.Linear(d_model, 32),
            nn.ReLU(),
            nn.Dropout(dropout),
    ...
    def forward(
        ...
        return {
            ...
            'ret_q10': self.ret_q10_head(cls_output),
            'ret_q90': self.ret_q90_head(cls_output),
        }
