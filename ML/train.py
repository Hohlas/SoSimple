...
def train_model(
    ...
    if not silent:
        _plot_training_curves(history, model_name, regression=(regression or entry_path))
...
def _log_experiment(
    ...
    if triple_barrier:
        ...
        log_suffix = f'_{ENTRY_PATH_TARGET}'
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        choices=['classification', 'regression', 'regression_updn', 'triple_barrier', ENTRY_PATH_TARGET],
        help="Задача: 'classification' | 'regression' (predict) | 'regression_updn' | 'triple_barrier' | 'entry_path_v1'. "
