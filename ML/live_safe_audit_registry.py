...
class AuditedSystem:
    ...
    checkpoint_path: str = ""
    rule_path: str = ""
    prediction_paths: tuple[str, ...] = field(default_factory=tuple)
    report_paths: tuple[str, ...] = field(default_factory=tuple)
    expected_risk_note: str = ""


AUDITED_SYSTEMS: tuple[AuditedSystem, ...] = (
    AuditedSystem(
        system_name="quality",
    ...
    AuditedSystem(
        ...
        checkpoint_path="ML/reports/take_skip_original_contour_feature_matrix/original_plus_path_seq50/checkpoint.pt",
        rule_path="ML/reports/take_skip_trailing_stop_v2_original_plus_path_selected_rule.json",
        prediction_paths=(
            "ML/reports/take_skip_original_contour_feature_matrix/original_plus_path_seq50/take_skip_trailing_stop_v2_validation_predictions.csv",
            "ML/reports/take_skip_original_contour_feature_matrix/original_plus_path_seq50/take_skip_trailing_stop_v2_test_predictions.csv",
        ),
        report_paths=("docs/reports/2026-04-20-take-skip-original-contour-feature-ablation.md",),
        expected_risk_note="Explicitly covered by the unsafe original_contour online contract finding.",
    ),
    AuditedSystem(
        system_name="entry_path_v1",
        checkpoint_path="ML/checkpoints/transformer_entry_path_v1_best.pt",
    ...
    AuditedSystem(
        ...
        checkpoint_path="ML/checkpoints/transformer_entry_path_v1_quantile_best.pt",
        rule_path="ML/reports/entry_path_v1_quantile_selected_rule.json",
        prediction_paths=(
        ...
        expected_risk_note="Quantile checkpoint appears cleaner, but production rule depends on entry_path_v1 baseline score.",
    ),
)


def get_audited_systems() -> tuple[AuditedSystem, ...]:
    return AUDITED_SYSTEMS
