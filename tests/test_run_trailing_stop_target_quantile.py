...
def test_single_run_fails_when_required_checkpoint_source_missing_even_with_stale_destination(monkeypatch, tmp_path):
    import ML.run_trailing_stop_target_quantile as runner
    ...
    run_dir = tmp_path / 'quantile' / 'transformer_seq20_x3_quantile'
    run_dir.mkdir(parents=True)
    stale_checkpoint = run_dir / 'checkpoint.pt'
