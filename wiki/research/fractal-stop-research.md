...
- **Stage 5.4 price/ATR ablation (2026-06-29):** Проведён вокруг fixed target `fast`. 12 профилей × 2 стороны × 3 seeds = 72 XGBoost. Primary `price_coord_atr` не улучшает `fast` ни на sell (медианная дельта +0.0066, 0/3 seeds), ни на buy (дельта +0.0014, 0/3 seeds). A7 preflight: все комбинации WARNING (ZERO_GT95), ни одного ERROR. Статус: **REJECT_PRICE_COORD**. Price/ATR признаки не объясняют missing `fast` сигнал. Расширение price-поиска не требуется.
