...
- **Стоит ли делать Stage 5.4 price/ATR ablation вокруг `fast`?** Это разрешённый следующий диагностический шаг, но scope должен быть узким: target family фиксированная, без Up/Dn по умолчанию и без одновременного широкого поиска целей.
