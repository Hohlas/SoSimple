...
**Все этапы (Stage 2→5.1b) отклонены как торговые кандидаты.** Табличные модели достигли потолка, Transformer не дал устойчивого улучшения, а диагностика устойчивости сигнала во времени не дала жёсткого решения. Stage 5.1/5.1b уточнили носитель структурного сигнала, но не переоткрыли `H6_off05`. Ветка остаётся в диагностическом неопределённом статусе.
