...
- Следующий зафиксированный шаг после Stage 6.3 — `Regression Up/Dn target foundation`. Возврат к H12 OHLC-window variations запрещён без materially new information family.
