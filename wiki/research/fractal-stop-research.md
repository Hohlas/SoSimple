...
- **Стоит ли делать Stage 5.4 price/ATR ablation вокруг `fast`?** Это ближайший разрешённый диагностический шаг: target family фиксированная (`fast`), sell — основная проверка, buy — пограничный disclosure, без Up/Dn по умолчанию и без одновременного широкого поиска целей.
