...
**Все этапы (Stage 2→5.1) отклонены как торговые кандидаты.** Табличные модели достигли потолка, Transformer не дал устойчивого улучшения, а диагностика устойчивости сигнала во времени не дала жёсткого решения. Stage 5.1 уточнил носитель структурного сигнала, но не переоткрыл `H6_off05`. Ветка остаётся в диагностическом неопределённом статусе.
...
- **Заслуживает ли `back` отдельного узкого follow-up?** Stage 5.1 выделил `back` как единственное `likely_useful` поле, но оно не заменяет весь `structure_full`. Если по `H6_off05` вообще делать ещё один диагностический шаг, он должен быть узким и заранее ограниченным: `time_only`, `time+back`, `time+impulse`, `time+back+impulse`, `structure_full`, `structure_full_without_back`.
- **Что делать с `impulse`?** Поле выглядит вторым по интересу, но Stage 5.1 не дал достаточной согласованности для `likely_useful`. Если проверять, только как часть того же узкого mini-follow-up вокруг `back`, а не отдельным широким поиском.
