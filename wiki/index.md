...
| [fractal-stop-research.md](research/fractal-stop-research.md) | Fractal Stop Stage 1-5.0b: breach, fav, exit, walk-forward, Transformer, A7-аудит признаков, `asinh`, buy loader fix. Stage 5.0b не дал превосходства Transformer над XGBoost; следующий узкий кандидат — `all100_absolute_price_atr_scaled_time_asinh`. | 18 report updates (06-10 — 06-22) |
