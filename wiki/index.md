...
| [fractal-stop-research.md](research/fractal-stop-research.md) | Stage 1—6.3 + Regression Up/Dn target line: breach, fav, exit, walk-forward, Transformer, A7-аудит, profile screening, time-to-breach reformulation, price/ATR ablation, outcome-based triple-barrier, H12/H6 geometry and price-action parity check, `range_w1_atr` post-mortem, target foundation, ratio audit, already-moved audit, next-open entry target foundation, entry-based price-feature matrix, fractal selection ablation, closeout, powerful tabular capacity check, ordered sequence Transformer, amplitude movement-regime audit, bounded movement filter, freeze-репликация, repaired direction-inside-mask reject, rich-features full grid, narrow seed-stability replication, `fractal0_price` retest-zone oracle и полный Fractal0 entry/exit grid. Итог последнего подцикла: full M5 entry/exit grid выбрал `E3_open_pullback_1_0atr / M0_no_mask / X0_fixed_r_0_7`, `val_eval PF=2.7247`, `BS_p05=2.4868`, stress PF `2.2945`, permutation PASS; статус `research_only`, следующий шаг — stop-policy / entry-quality follow-up без `locked_test`. | 50 report updates (06-10 — 07-21) |
