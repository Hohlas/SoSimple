...
| [fractal-stop-research.md](research/fractal-stop-research.md) | Fractal Stop Stage 1-5.2: breach, fav, exit, walk-forward, Transformer, A7-аудит, `asinh`, XGBoost+Logistic скрининг, проверка переобучения, диагностика устойчивости сигнала, structural/Up-Dn ablation и time-to-breach regression. Stage 5.2 after bugfix/rerun: time-to-breach ранжирование есть (`Spearman≈0.31-0.33`, `AUC≈0.70`), лучший сигнал снова вокруг `back`, но candidate-gate не пройден из-за MAE хуже constant baseline и невалидного oracle comparison. | 25 report updates (06-10 — 06-25) |
