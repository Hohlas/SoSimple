...
| [fractal-stop-research.md](research/fractal-stop-research.md) | Stage 1—6.3 + Regression Up/Dn target line: breach, fav, exit, walk-forward, Transformer, A7-аудит, profile screening, time-to-breach reformulation, price/ATR ablation, outcome-based triple-barrier, H12/H6 geometry and price-action parity check, `range_w1_atr` post-mortem, target foundation, ratio audit, already-moved audit, next-open entry target foundation, entry-based price-feature matrix, fractal selection ablation, closeout, powerful tabular capacity check и ordered sequence Transformer. Итог последнего подцикла: top-level `up_*/dn_*` содержат сильный сигнал от `fractal0_price`, но схема входа `next open after signal_time` не прошла direction даже после сильных табличных моделей и текущей ограниченной sequence-матрицы; следующий честный target — amplitude / movement-regime или другая entry-механика, а не продолжение вопроса `up or down` от next open. Это не закрывает глобально всю идею фрактальной последовательности. | 41 report updates (06-10 — 07-07) |
