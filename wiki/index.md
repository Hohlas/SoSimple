...
| [fractal-stop-research.md](research/fractal-stop-research.md) | Fractal Stop Stage 1-5.0a: breach, fav, exit, Transformer, feature preflight. Corridor full addendum показал: old capped corridor искажал coverage, а rerun обсуждать нужно уже через `corridor_*_atr_full`. | 12 report updates (06-10 — 06-18) |
