...
| [fractal-stop-research.md](research/fractal-stop-research.md) | Stage 1—6.2: breach, fav, exit, walk-forward, Transformer, A7-аудит, profile screening, time-to-breach reformulation, price/ATR ablation, outcome-based triple-barrier, H12 relative fractal geometry, H12 price action. Stage 6.2 found weak price-action signal but failed permutation and additive delta gates. | 30 report updates (06-10 — 06-30) |
