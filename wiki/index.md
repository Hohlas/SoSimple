...
| [fractal-stop-research.md](research/fractal-stop-research.md) | Stage 1—6.3 + Regression Up/Dn target line: breach, fav, exit, walk-forward, Transformer, A7-аудит, profile screening, time-to-breach reformulation, price/ATR ablation, outcome-based triple-barrier, H12/H6 geometry and price-action parity check, `range_w1_atr` post-mortem, target foundation, ratio audit, already-moved audit, next-open entry target foundation, entry-based price-feature matrix, fractal selection ablation, closeout, powerful tabular capacity check, ordered sequence Transformer, amplitude movement-regime audit, bounded movement filter, freeze-репликация, repaired direction-inside-mask reject, rich-features full grid, narrow seed-stability replication, `fractal0_price` retest-zone oracle, полный Fractal0 entry/exit grid и stop-policy grid. Итог последнего подцикла: stop-grid выбрал `S2_fractal0_buffer_0_5_entry_floor_2 / E3_open_pullback_1_0atr / M0_no_mask / X2_ml_opposite_any_p0_50`, `val_eval PF=2.7873`, `BS_p05=2.5085`, но не доказал превосходство над S0/X0 baseline по BS_p05; статус `research_only`, stress-spread отложен для shortlist, `locked_test` не открыт. | 51 report updates (06-10 — 07-21) |
