...
| [fractal-stop-research.md](research/fractal-stop-research.md) | Stage 1—6.3 + Regression Up/Dn target line: breach, fav, exit, walk-forward, Transformer, A7-аудит, profile screening, time-to-breach reformulation, price/ATR ablation, outcome-based triple-barrier, H12/H6 geometry and price-action parity check, `range_w1_atr` post-mortem, target foundation, ratio audit, already-moved audit, next-open entry target foundation, entry-based price-feature matrix, fractal selection ablation, closeout, powerful tabular capacity check, ordered sequence Transformer, amplitude movement-regime audit, bounded movement filter, freeze-репликация, repaired direction-inside-mask reject, rich-features full grid, narrow seed-stability replication, `fractal0_price` retest-zone oracle, полный Fractal0 entry/exit grid, stop-policy grid, entry-quality filter, rich-entry quality search, normalized rich-entry rerun, [time-only robustness audit](../docs/reports/2026-07-23-time-only-robustness-audit.md), [leaderboard robustness audit](../docs/reports/2026-07-23-fractal0-rich-entry-leaderboard-robustness-audit.md), [leaderboard closure audit](../docs/reports/2026-07-23-fractal0-leaderboard-cost-calendar-sequential-multiseed-closure.md), [fixed11 internal closure rerun](../docs/reports/2026-07-23-fractal0-fixed11-internal-closure-rerun.md), [fixed11 locked test](../docs/reports/2026-07-24-fractal0-fixed11-locked-test.md), [fixed11 candidate audit](../docs/reports/2026-07-25-fractal0-fixed11-candidate-audit.md), [fixed11 mutual-correlation pruning](../docs/reports/2026-07-27-fractal0-fixed11-mutual-correlation-pruning.md), [fixed11 retained-subset MT4 parity diagnostic](../docs/reports/2026-07-27-fractal0-fixed11-retained-subset-mt4-parity.md), [fixed11 fill chronology audit](../docs/reports/2026-07-29-fixed11-python-mt4-fill-chronology.md), [fixed11 current-history OHLC rerun](../docs/reports/2026-07-29-fixed11-current-history-rerun.md), [fixed11 Python H1 chronology fix](../docs/reports/2026-07-29-fixed11-python-h1-chronology-fix.md) и [MT5 execution-loop diagnostic prototype](../docs/reports/2026-07-29-mt5-execution-loop-migration.md). Итог: corrected Python chronology убрала same-H1 `ML_CLOSE`, но diagnostic rerun уничтожил старый edge (`PF max=0.938880`, `kept_candidates=0`); MT5 prototype подготовлен как новый execution-контур, но `Nero.csv` parity и tester metrics ещё не получены. | 66 report updates (06-10 — 07-29) |
| [mt5-execution-loop.md](research/mt5-execution-loop.md) | MT5 Strategy Tester diagnostic contour: feasibility/runbook/design, single-rule run, OnTradeTransaction lifecycle, Nero parity, batch selection, execution hygiene, post-batch diagnostics and explicit timing contract | 9 reports (07-29 — 08-01) |
| [mi-upper-bound.md](research/mi-upper-bound.md) | MI-потолок предсказуемости XAUUSD H1: amplitude предсказуема (p=0.005), direction нет (p=0.229); диагностический R²-потолок 0.006–0.030 кратно ниже legacy R²; rolling MI стабилен 2004–2026 | 1 report (08-11) |
| [pair-spread-kill-test.md](research/pair-spread-kill-test.md) | Pair-spread kill-test (idea-01): предрегистрированный двухступенчатый тест парного стат. арбитража на 7 кандидатах — все убиты на Stage 1 (EG p, half-life, эпизоды/год); decision `close`, тема закрыта | 1 report (08-27) |
...
| [mi-upper-bound.md](concepts/mi-upper-bound.md) | Диагностический R²-потолок из маргинального MI (bits): gate — permutation p-value, fold-CI — только стабильность, не joint-граница |
