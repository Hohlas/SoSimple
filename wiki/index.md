...
| [fractal-stop-research.md](research/fractal-stop-research.md) | Fractal Stop Stage 1-5.1: breach, fav, exit, walk-forward, Transformer, A7-аудит, `asinh`, XGBoost+Logistic скрининг, проверка переобучения, диагностика устойчивости сигнала и structural field ablation. Stage 5.1: `back` = единственное `likely_useful` поле, но не замена полного профиля; `impulse` = интересный, но не подтверждённый след; ветка `H6_off05` остаётся `DIAGNOSTIC_ONLY`. | 23 report updates (06-10 — 06-24) |
