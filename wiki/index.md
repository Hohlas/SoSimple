...
| [fractal-stop-research.md](research/fractal-stop-research.md) | Fractal Stop Stage 1-5.3: breach, fav, exit, walk-forward, Transformer, A7-аудит, `asinh`, XGBoost+Logistic скрининг, проверка переобучения, диагностика устойчивости сигнала, structural/Up-Dn ablation и time-to-breach reformulation. Stage 5.3: bucket `fast` найден как лучшая дискретная target family; sell проходит target-reformulation gate, buy пограничен и проходит порог delta только в 1/3 seed, этап остаётся диагностическим. | 26 report updates (06-10 — 06-26) |
