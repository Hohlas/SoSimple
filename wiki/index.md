...
| [fractal-stop-research.md](research/fractal-stop-research.md) | Stage 1—6.3 + Regression Up/Dn target foundation: breach, fav, exit, walk-forward, Transformer, A7-аудит, profile screening, time-to-breach reformulation, price/ATR ablation, outcome-based triple-barrier, H12/H6 geometry and price-action parity check, `range_w1_atr` post-mortem, and clean target foundation on top-level `up_*/dn_*`. Stage 6.3 did not rescue H6 additive feature search; target foundation then showed strong short-horizon signal in `structure_full`, а post-review refresh уточнил честный feature-read audit и calendar disclosure. | 33 report updates (06-10 — 06-30) |
