...
| [fractal-stop-research.md](research/fractal-stop-research.md) | Fractal Stop Stage 1-4.2: breach подтверждён, oracle показал диагностический потолок, но RF/XGBoost trading layer, controls и corrected diagnostic recalc не дали устойчиво прибыльный PF | 5 report updates (06-10 — 06-12) |
