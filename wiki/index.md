...
| [fractal-stop-research.md](research/fractal-stop-research.md) | Fractal Stop Stage 1-4.1: breach подтверждён, oracle показал диагностический потолок, но RF/XGBoost trading layer и Stage 4.1 controls не дали статистически значимый PF | 4 reports (06-10 — 06-11) |
