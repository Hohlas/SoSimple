# Plan: Диагностический анализ Oracle vs Stage 4

## Гипотеза
Oracle показывает PF=∞, а Stage 4.2 — PF=1.015. Нужно понять: **что конкретно не работает — breach-классификатор или fav-регрессия?**
...
- Оба дают巨大的PF, но perfect_breach стабильно выше для H6 комбинаций
