...
и прочие примитивные отжившие методы. Также запрещены: тиковые данные и
таймфреймы ниже M5 (стакан, тиковые дисбалансы), макроэкономические
показатели и события (ставки, экономический календарь). 
...
2. Удали идеи, нарушающие жёсткий запрет: классические индикаторы
   ...
   методы; идеи, требующие тиковых данных или таймфреймов ниже M5
   (стакан, тиковые дисбалансы); идеи на макроэкономических показателях
   и событиях (ставки, экономический календарь). Больше не
   удаляй ничего: новизну проверяет спор.
